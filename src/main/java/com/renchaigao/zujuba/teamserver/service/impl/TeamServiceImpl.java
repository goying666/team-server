...
//        返回创建结果
    ...
    public ResponseEntity FindOneTeam(String userId, String teamId, String jsonObjectString) {
        TeamInfo teamInfo = mongoTemplate.findById(teamId, TeamInfo.class, MongoDBCollectionsName.MONGO_DB_COLLECIONS_NAME_TEAM_INFO);
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("teamInfo", teamInfo);
        jsonObject.put("teamBasic", "");
        return new ResponseEntity(RespCode.SUCCESS, jsonObject);
    }
