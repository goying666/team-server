...
public interface TeamService {
    //    用户创建一个team
    ResponseEntity CreateNewTeam(String userId, String parameter, String teamId, String jsonObjectString);
    ...
    ResponseEntity JoinTeam(String userId, String parameter, String teamId, String jsonObjectString);
    ...
    ResponseEntity GetNearTeams(String userId, String parameter, String teamId, String jsonObjectString);

    ResponseEntity FindOneTeam(String userId, String parameter, String teamId, String jsonObjectString);
